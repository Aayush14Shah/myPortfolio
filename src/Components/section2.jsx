...
const Section2 = (props) => {
  ...
  return (
    ...
    >
      ...
      {/* ) : ( */}
      <div
        className={`sm:hidden block text-wrap text-justify rounded-md w-full xl:w-full lg:w-full md:w-full sm:w-full h-full p-5 lg:p-5 md:p-[15px] sm:p-3 md:overflow-y-auto sm:overflow-y-auto my-auto row-span-3 lg:row-span-2 md:row-span-2
      ...
      >
        <h1
          id="text"
          className=" text-3xl md:text-2xl sm:text-2xl font-semibold font-stone-400   "
        >
        ...
        <div className="my-[2%] flex md:flex-col justify-between  ">
          <img
            className=" block w-[250px] h-[350px] xl:w-[200px] xl:h-[300px] lg:w-[180px] lg:h-[265px] md:w-[180px] md:h-[250px] rounded-lg "
            src={`${process.env.PUBLIC_URL}/Images/profile2.jpg`}
            alt="My profile"
          />
          <div className="w-[300px] lg:w-full xl:w-full md:w-full mx-[3%] md:mx-[1%] lg:space-y-1 xl:space-y-1.5 space-y-4  ">
            <h1
        ...
        <p className="my-2 text-lg sm:text-sm font-blue-500 leading-8 xl:leading-normal sm:leading-2 xl:tracking-normal tracking-wide sm:tracking-medium text-justify sm:line-clamp-2 md:line-clamp-8">
      ...
      {/* )} */}
      <div
        className={`rounded-md text-justify w-[800px] xl:w-[520px] lg:w-[320px] md:w-[300px] sm:w-[calc(100%-10px)] h-full  p-5 lg:p-5 md:p-[15px] sm:p-3 md:overflow-y-auto sm:overflow-y-auto my-auto col-span-2 lg:col-span-1 md:col-span-1 sm:row-span-1 sm:col-span-2 row-span-2 sm:row-span-2 lg:row-span-2 md:row-span-2 mx-auto lg:mx-[5px] -sm:mx-auto ${
          data.mode ? "bg-indigo-100" : "bg-[#313552]"
        } ${data.mode ? "text-slate-800" : "text-white"}  `}
      >
      ...
      >
        ...
        {circles.map((circle) => (
          ...
          >
            <div className="mx-auto flex items-center justify-center w-[90px] xl:w-[65px] xl:h-[65px] h-[90px] lg:w-[80px] sm:w-[60px] lg:h-[80px] md:w-[80px] md:h-[80px] sm:w-[60px] sm:h-[60px]">
              <svg>
                <circle
                  cx="50%"
                  cy="50%"
